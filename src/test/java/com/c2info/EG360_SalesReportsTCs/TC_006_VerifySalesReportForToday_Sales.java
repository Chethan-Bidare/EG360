...
public class TC_006_VerifySalesReportForToday_Sales extends TestBase {

	public static final Logger log = Logger.getLogger(TC_006_VerifySalesReportForToday_Sales.class.getName());
