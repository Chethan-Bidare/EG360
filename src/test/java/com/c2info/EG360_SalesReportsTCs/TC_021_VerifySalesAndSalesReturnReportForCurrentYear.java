...
public class TC_021_VerifySalesAndSalesReturnReportForCurrentYear extends TestBase{
	...
	public void verifyBranchWiseNumberOfInvoices() throws InterruptedException, SQLException{
		...
		for(String str : set){
			...
			String query = "select count(*) from inv_mst where c_br_code='"+brCode+"' and "
					+ "n_cancel_flag=0 and d_date>='"+getCurrentYearStartDate()+"' and d_date<='"+getCurrentQuarterEndDate()+"'";
